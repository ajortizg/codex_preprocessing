...
def entropy(
    ...
    prob_density, edges = np.histogram(image, bins=bins, range=(vmin, vmax), weights=weights, density=True)
...
def autotune_cost(
    ...
    if n < fourier_l0_norm_threshold:
        ...
        fourier_L0_norm_cost = (n - fourier_l0_norm_threshold) * fourier_l0_norm_cost_coef
